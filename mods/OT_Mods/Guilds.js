  ...
  (async () => {
    ...
    if (equippedItem) {
      ...
      if (parseInt(equippedItem.gameId) === 99999) {
        ...
        iconImg.className = 'sprite item relative id-3253';
        iconImg.title = 'Fur Backpack';
        iconImg.style.cssText = 'width: 32px; height: 32px; overflow: hidden;';
        iconImg.innerHTML = '<div class="viewport" style="width:100%;height:100%;overflow:hidden;"><img alt="Fur Backpack" data-cropped="false" class="spritesheet" style="--cropX: 0; --cropY: 0;"></div>';
