...
const modDescriptions = {
  ...
  'Highscore Improvements': 'Richer highscores with extra stats, sorting, and room breakdowns.',
  ...
  'Usage List': 'Creature and equipment usage tiers from each map\'s saved Auto-setup.',
