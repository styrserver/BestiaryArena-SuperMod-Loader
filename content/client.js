...
(function() {
  ...
  window.addEventListener('message', function(event) {
    ...
    if (event.data && event.data.from === 'BESTIARY_EXTENSION' && event.data.extensionBaseUrl) {
      window.BESTIARY_EXTENSION_BASE_URL = event.data.extensionBaseUrl;
      console.debug('[BestiaryModAPI] Set BESTIARY_EXTENSION_BASE_URL:', window.BESTIARY_EXTENSION_BASE_URL);
    }
  });
