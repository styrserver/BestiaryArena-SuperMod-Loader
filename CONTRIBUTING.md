...
6. If you change Quest mod content under `assets/quests/`, see [Quest mod data](assets/quests/README.md) for the JSON layout, reward field conventions, and new-mission checklist
