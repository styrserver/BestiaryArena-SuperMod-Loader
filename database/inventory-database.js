...
const INVENTORY_CATEGORIES = {
  ...
  'Runes': ['Blank Rune', 'Hitpoints Rune', 'Ability Power Rune', 'Attack Damage Rune', 'Armor Rune', 'Magic Resist Rune'],
...
const INVENTORY_VARIANTS = {
  ...
  'Blank Rune': ['runeBlank'], 'Hitpoints Rune': ['runeHp'], 'Ability Power Rune': ['runeAp'], 'Attack Damage Rune': ['runeAd'], 'Armor Rune': ['runeAr'], 'Magic Resist Rune': ['runeMr'],
