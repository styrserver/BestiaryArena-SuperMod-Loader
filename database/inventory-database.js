...
// Cleanup function for inventory database
window.cleanupdatabaseinventorydatabasejs = function(periodic = false) {
  console.log('[inventory-database.js] Running cleanup...');
  ...
  console.log('[inventory-database.js] Cleanup completed');
};
