        ...
        <div style="padding: 20px; text-align: center;">
          ...
          <div style="background: rgba(0,0,0,0.2); border-radius: 8px; padding: 20px; margin-bottom: 20px;">
            ...
            <div style="text-align: left; color: #a6adc8; line-height: 1.8;">
              ...
              <p><strong>🚀 ${superCount} Super Mods:</strong> Autoseller, Cyclopedia, Hunt Analyzer, Outfiter, Raid Hunter, <em>Rank Pointer</em>, and more! <em>(Disabled by default)</em></p>
