...
// Get translation from JSON by path (e.g., 'popup.searchPlaceholder'), falling back to
// `fallback` (default null) when translations fail to load or the path isn't found.
async function getTranslation(translationPath, fallback = null) {
