...
- "Maxed" follows the game's real level caps: 99 for awakened creatures, otherwise 30/35/40/45/50 by star count (no stars caps at 30, and each star adds 5 up to 50 at four stars)
- Queue and picker portraits mirror the game's own creature slots: star tier in the top-right corner (awakened and shiny/hundo copies get their own star), gene-stat rarity border, and level badge
